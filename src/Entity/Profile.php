...
class Profile
{
    ...
    public function getRxSocial(): ?string
    {
        return $this->rxSocial;
    }

    public function setRxSocial(string $rxSocial): static
    {
        $this->rxSocial = $rxSocial;
